...
<head>
    ...
    <title>Page Expired — Huzaifa Store</title>
...
<body class="bg-slate-950 text-gray-100 antialiased min-h-screen flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <p class="text-gray-400 text-lg mb-8 max-w-md mx-auto">Your session has expired. Please refresh the page and try again.</p>
