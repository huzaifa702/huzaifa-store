...
<head>
    ...
    <title>Page Not Found — Huzaifa Store</title>
...
<body class="bg-slate-950 text-gray-100 antialiased min-h-screen flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onclick="history.back()" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-slate-800 hover:bg-slate-700 text-white border border-slate-600 rounded-xl font-semibold transition-all">
